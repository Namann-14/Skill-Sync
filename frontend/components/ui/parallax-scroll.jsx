...
export const ParallaxScroll = ({
  ...
  const thirdPart = images.slice(2 * forth);
  const forthPart = images.slice(forth, 2 * forth);

  return (
    (<div
      className={cn("h-[40rem] items-start overflow-y-auto w-full bg-black", className)}
      ref={gridRef}>
      <div
